...
BLOFIN_FUTURES_TAKER_FEES = 0.0006
BLOFIN_MARKET_ORDER_SLIPPAGE_BUFFER = 0.025  # BloFin's 2.5% Market Order limit ratio
BLOFIN_MARKET_ORDER_SAFETY_FACTOR = (
    1 - BLOFIN_MARKET_ORDER_SLIPPAGE_BUFFER
)  # 2.5% less to avoid insufficient balance errors
...
DEFAULT_LONG_ENTRY_OVERSOLD_THRESHOLD = 0.35
DEFAULT_SHORT_ENTRY_OVERBOUGHT_THRESHOLD = 0.9
...
DEFAULT_RISK_MANAGEMENT_OPEN_TRADES_ON_WEEKENDS = True
