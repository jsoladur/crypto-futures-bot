...
REGEX = r"^toggle_push_notification_\$_(.+)$"
    ...
    if is_user_logged:
        try:
            ...
            push_notification_item = await push_notification_service.toggle_push_notification_by_type(
                chat_id=callback_query.message.chat.id, notification_type=notification_type
            )
        ...
        await callback_query.message.answer(
            ...
            reply_markup=keyboards_builder.get_login_keyboard(callback_query.message.chat.id),
        )
